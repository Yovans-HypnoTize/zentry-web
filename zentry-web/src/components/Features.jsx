...
const BentoTilt = ({ children, className = "" }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const newTransform = `perspective(750px) rotateX(${tiltX}deg) rotateY(${tiltY}deg) scale3d(0.99, 0.99, 0.99)`;
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          <BentoTilt className=" bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
              ...
              description={
                "An anime game-inspired NFT collection - the IP primed for expansion"
              }
            />
          </BentoTilt>
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-500 p-5">
              <h1 className="bento-title special-font text-black max-w-64">
                Mo<b>r</b>e com<b>i</b>ng s<b>o</b>on!
              </h1>
              <TiLocationArrow className="m-5 md:m-0 scale-[5] md:scale-[3] self-end " />
            </div>
          </BentoTilt>
